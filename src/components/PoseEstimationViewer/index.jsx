...
const DEFAULT_ANIMATED_URL = "swing-dance-black-man-white-jacket.glb"
function PoseModel({ url = DEFAULT_ANIMATED_URL, frame, animationData, isPlaying }) {
...
export default function PoseEstimationViewer() {
  const [modelData, setModelData] = useState(DEFAULT_ANIMATED_URL);
